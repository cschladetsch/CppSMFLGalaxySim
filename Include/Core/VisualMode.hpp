...
protected:
    [[nodiscard]] DisplaySystem& GetDisplaySystem() noexcept { return displaySystem_; }
    [[nodiscard]] const DisplaySystem& GetDisplaySystem() const noexcept { return displaySystem_; }
