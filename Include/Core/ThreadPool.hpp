...
public:
    ...
    requires std::ranges::range<Container> && std::invocable<F, typename Container::value_type&>
    ...
    void WaitForAll();
    [[nodiscard]] std::size_t GetNumThreads() const noexcept { return workers_.size(); }
